...
IQPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/9fd0a28073d92e3052fe3.jpg"
...
async def iq(iqthonevent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "𝗐𝖾𝗅𝖼𝗈𝗆𝖾 ᥴ.ᖇ ᥉᥆υᖇᥴᥱ 𓃠"
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/9fd0a28073d92e3052fe3.jpg"
...
‌‎⿻┊‌‎PinG 𖠄 {ping} ٫
‌‎⿻┊‌‎VeRsIoN 𖠄 (7.7) ,
‌‎⿻┊‌‎ََِِ𝗰.ًًٍٍ𝗥 ٍّّ𝘀ُُ𝗼ًًٍٍ𝗨ًًٍٍ𝗥ََِِ𝗰ََِِ𝗲 𖠄 @dr_criss"""

@iqthon.on(admin_cmd(pattern="رابط التنصيب(?: |$)(.*)"))    
async def source(e):
    await edit_or_reply(e, "https://github.com/xlucifer711/Arab",)
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ تـليثون كرستين  - Telethon-ᥴ.ᖇ ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"🝳︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس تليثون @iiqllll:**\n\n{o}")
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**🝳︙  📑 يرجى متابع قناه الفارات تجدها هنا : @pp_g3")
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqthon(iqthon):
        ...
        if query.startswith("تنصيب") and iqthon.query.user_id == bot.uid:
            buttons = [[Button.url("1- القناه", "https://t.me/pp_g3"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://replit.com/@telethon-Arab/generatestringsession#start.sh"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://dashboard.heroku.com/new?template=https://github.com/iiqllll/Arab"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/iiqllll"),]]
...
https://t.me/Teamtelethon/51
———————×——————— 
قناه المتغيرات او الفارات : @pp_g3 
شرح الأوامر : ( @dr_criss ) .
قناه السورس : ( @pp_g3 ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**🝳︙ قـائمـه الاوامـر :**\n**🝳︙ قنـاه السـورس :** @pp_g3 \n**🝳︙ شـرح اوامـر السـورس : @gro_up_1**\n**🝳︙ مطور السـورس : @iiqllll** "
