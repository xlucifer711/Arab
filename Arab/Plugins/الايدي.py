...
async def fetch_info(replied_user, event):
    ...
    rotbat = "⌁ من مطورين السورس 𓄂𓆃 ⌁" if user_id == 1355571767 or user_id == 1050898456 or user_id == 1001132193 or user_id == 627658332  else ("⌁ العضـو 𓅫 ⌁")
    rotbat = "⌁ مـالك الحساب 𓀫 ⌁" if user_id == (await event.client.get_me()).id and if user_id == (await event.client.get_me()).id
        and user_id != 1833610203
        and user_id != 627658332
        and user_id != 1099460779
        and user_id != 1355571767
        and user_id != 1050898456
        and user_id != 1001132193  else rotbat
